...
require (
	...
	github.com/google/osv-scalibr v0.5.3-0.20260819195802-c2094f2d68e3
...
replace github.com/google/osv-scalibr => github.com/comper-io/osv-scalibr v0.5.3-comper.3
